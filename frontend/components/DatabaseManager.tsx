    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-end">
      ...
      <div className="relative bg-white w-full max-w-md h-full shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-right duration-300">
                 ...
                 <div className="grid grid-cols-1 gap-3">
                   <button 
                    onClick={() => {
                      ...
                      a.href = url;
                      a.download = `agro_backup_${user.phone}.json`;
                      a.click();
                    }}
                   ...
                   <button 
                    onClick={() => {
                      if(confirm('Wipe your personal search vault? Other users will not be affected.')) {
                        localStorage.removeItem(`agro_smart_db_v2_${user.phone}`);
        ...
        <div className="p-8 bg-slate-50 text-center">
          <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.4em] mb-1">AgroSmart Identity Engine</p>
